...
Link: https://leetcode.com/problems/meeting-scheduler/description/?envType=company&envId=citadel&favoriteSlug=citadel-six-months
...
Intuition:
nested loop takes too long, we dont have to go that route, instead we could just increment the limiting slot, and find the common slot that fits the duration 
