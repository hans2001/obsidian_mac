...
Link:https://leetcode.com/problems/maximum-profit-from-trading-stocks/description/?envType=company&envId=blackrock&favoriteSlug=blackrock-more-than-six-months
## Problem: 
...
- `0 <= budget <= 1000`
## Intuition:
pre filter the stock that is not going to make any money, then run that with dfs knapsack problem, added memoization to avoid recompute at the decision tree level
## Solution:
![[Screenshot 2025-07-10 at 2.02.55 PM.png]]
Tags: #dp #tabulation
